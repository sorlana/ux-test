...
function saveNewRowFromPopup() {
    ...
    const rowData = { service, unit, quantity, rate, total, vat, contractor, contract };
    if (currentVariantForAdd === "variant2") {
        ...
        newRow.innerHTML = `
          <div class="table-cell"><div class="txt">${rowData.service}</div></div>
          <div class="table-cell"><div class="txt">${rowData.unit}</div></div>
          <div class="table-cell"><div class="txt">${rowData.quantity}</div></div>
          ...
          <div class="table-cell"><div class="txt">${rowData.contractor}</div></div>
          <div class="table-cell"><div class="txt">${rowData.contract}</div></div>
...
function addNewRowToTable2(data) {
    ...
    if (isEditingMode2) {
        newRow.innerHTML = `
          ...
          <div class="table-cell"><input type="number" class="fm" value="${data.quantity}"></div>
          <div class="table-cell"><input type="number" class="fm" value="${data.rate}"></div>
          <div class="table-cell"><input type="number" class="fm" value="${data.total}" readonly></div>
          <div class="table-cell">
            <select class="fm-select">
          ...
          <div class="table-cell">
            <select class="fm-select">
              <option value="${data.contractor}" selected>${data.contractor || '-- Выберите --'}</option>
          ...
          <div class="table-cell">
            <select class="fm-select">
              <option value="${data.contract}" selected>${data.contract || '-- Выберите --'}</option>
        ...
        newRow.innerHTML = `
          ...
          <div class="table-cell"><div class="txt">${data.contractor}</div></div>
